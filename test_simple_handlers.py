...
def test_connect_handler_basic():
    ...
    def mock_connect_handler(event, context):
        ...
        return {
            "statusCode": 200,
            "body": json.dumps({"message": "Verbunden", "connection_id": connection_id, "status": "connected"}),
        }
...
def test_disconnect_handler_basic():
    ...
    def mock_disconnect_handler(event, context):
        ...
        return {
            "statusCode": 200,
            "body": json.dumps({"message": "Getrennt", "connection_id": connection_id, "status": "disconnected"}),
        }
...
def test_authorizer_basic():
    ...
    def mock_authorizer(event, context):
        ...
        return {
            ...
            "context": {"message": "Authorization successful" if effect == "Allow" else "Authorization failed"},
        }
        ...
        result = {
            **event,
            ...
            "normalization_applied": (
                address.get("street", "") != normalized_address["street"]
                or address.get("city", "") != normalized_address["city"]
            ),
        }
...
if __name__ == "__main__":
    ...
    tests = [test_connect_handler_basic, test_disconnect_handler_basic, test_authorizer_basic, test_address_normalizer_basic]

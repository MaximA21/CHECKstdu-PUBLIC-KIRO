...
def lambda_handler(event, context):
    ...
    try:
        ...
        if event.get("warmer"):
            return {
                "statusCode": 200,
                "body": json.dumps({"message": "Lambda warmed successfully", "function": "disconnect_handler"}),
            }
        ...
        return {"statusCode": 500, "body": json.dumps({"error": "Internal server error", "message": "Disconnection failed"})}

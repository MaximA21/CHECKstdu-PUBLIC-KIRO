...
class ShareController(ContainerController):
    ...
    async def handle_request(self, request_data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            ...
            # Log success
            self._log_request_success("Share API", {
            ...
            self._log_request_error("Share API", {"share_token": share_token if 'share_token' in locals() else 'unknown'}, start_time, e)
    ...
    async def get_statistics(self, request_data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            ...
            # Log success
            self._log_request_success("Share Stats", {
                "share_token": share_token
            }, start_time)
            ...
            self._log_request_error("Share Stats", {"share_token": share_token if 'share_token' in locals() else 'unknown'}, start_time, e)
            return self._create_error_response(404, "Share link not found or expired")
    ...
    async def extend_expiration(self, request_data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            ...
            # Log success
            self._log_request_success("Extend Share", {
                "share_token": share_token,
                "days_extended": days
            }, start_time)
            ...
            self._log_request_error("Extend Share", {"share_token": share_token if 'share_token' in locals() else 'unknown'}, start_time, e)
            return self._create_error_response(404, "Share link not found or expired")

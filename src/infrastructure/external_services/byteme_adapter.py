        ...
        try:
            ...
            df_clean = df_unique.with_columns(
                [
                    ...
                    pl.col("afterTwoYearsMonthlyCost")
                    .cast(pl.Int32, strict=False)
                    .fill_null(0)
                    .alias("after_two_years_clean"),
                    ...
                    pl.col("installationService")
                    .cast(pl.Utf8)
                    .str.to_lowercase()
                    .is_in(["true", "1", "yes"])
                    .alias("installation_clean"),
        ...
        try:
            ...
            for line in lines[1:]:
                ...
                try:
                    ...
                    offer.add_feature(
                        "voucher_value_euros", Decimal(self._safe_int(fields[col_map.get("voucherValue", 11)])) / 100
                    )

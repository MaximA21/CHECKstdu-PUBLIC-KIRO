...
class CloudWatchDestination(ILogDestination):
    ...
    def __init__(self, log_group: str, log_stream: Optional[str] = None, region: str = "us-east-1"):
        """
    ...
    async def _ensure_log_stream(self) -> bool:
        ...
        try:
            ...
            try:
                client.create_log_stream(logGroupName=self._log_group, logStreamName=self._log_stream)
        ...
        try:
            ...
            for entry in log_entries:
                ...
                events.append(
                    {
                        "timestamp": (
                            int(entry.get("timestamp", 0) * 1000)
            ...
            # Send to CloudWatch
            put_args = {"logGroupName": self._log_group, "logStreamName": self._log_stream, "logEvents": events}
...
class FileDestination(ILogDestination):
    ...
    def __init__(self, file_path: str, max_file_size: int = 10 * 1024 * 1024, backup_count: int = 5):
        """

...
class CloudWatchLogger(ConsoleLogger):
    ...
    def __init__(self, name: str, level: Optional[LogLevel] = None, 
                 log_group: Optional[str] = None, log_stream: Optional[str] = None):
        """
    ...
    def _enhance_with_cloudwatch_metadata(self, message: str, 
    ...
    def log_lambda_timeout_warning(self, remaining_time_ms: float) -> None:
        ...
        context = {
            'event_type': 'lambda_timeout_warning',
...
class CloudWatchLoggerFactory(ILoggerFactory):
    ...
    def create_structured_logger(self, name: str, 
                                level: Optional[LogLevel] = None) -> ILogger:
    ...
    def create_lambda_logger(self, function_name: str) -> ILogger:
        ...
        if logger_name not in self._loggers:
            ...
            self._loggers[logger_name] = CloudWatchLogger(
                logger_name, 
                log_group=log_group
            )

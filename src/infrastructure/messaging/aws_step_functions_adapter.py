...
class AWSStepFunctionsOrchestrator(IWorkflowOrchestrator):
    ...
    async def get_workflow_status(self, execution_id: str) -> WorkflowStatus:
        ...
        try:
            response = self._stepfunctions.describe_execution(
    ...
    async def stop_workflow(self, execution_id: str, reason: str = "User requested") -> bool:
        ...
        try:
            self._stepfunctions.stop_execution(
                executionArn=execution_id,
                error='UserRequested',
                cause=reason
            )
    ...
    async def list_workflow_executions(self, workflow_name: str, 
        ...
        try:
            ...
            list_params = {
                'stateMachineArn': state_machine_arn,
                'maxResults': min(max_results, 1000)  # AWS max is 1000
            }
    ...
    def create_state_machine(self, name: str, definition: Dict[str, Any], 
                           role_arn: str, machine_type: str = 'STANDARD') -> str:
        """
    ...
    def delete_state_machine(self, workflow_name: str) -> bool:
        ...
        try:
            ...
            self._stepfunctions.delete_state_machine(
                stateMachineArn=state_machine_arn
            )

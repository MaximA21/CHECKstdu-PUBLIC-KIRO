...
class AWSAPIGatewayWebSocketManager(IConnectionManager):
    ...
    def __init__(self, api_endpoint: str, region_name: str = 'eu-central-1', 
...
class AWSWebSocketTopicManager(ITopicManager):
    ...
    async def publish_to_topic(self, topic: str, message: Dict[str, Any]) -> int:
        ...
        try:
            ...
            results = await self.connection_manager.send_to_multiple_connections(
                list(subscribed_connections), 
                topic_message
            )

...
class AWSSQSMessageQueue(IMessageQueue):
    ...
    def _get_message_attributes(self, priority: MessagePriority) -> Dict[str, Any]:
        ...
        attributes = {
            "Priority": {"StringValue": priority.value, "DataType": "String"},
            "Timestamp": {"StringValue": datetime.utcnow().isoformat(), "DataType": "String"},
        }

        # Add priority-specific attributes
        if priority == MessagePriority.HIGH:
            attributes["HighPriority"] = {"StringValue": "true", "DataType": "String"}
        elif priority == MessagePriority.URGENT:
            attributes["Urgent"] = {"StringValue": "true", "DataType": "String"}
            ...
            for msg in messages:
                try:
                    ...
                    formatted_message = {
                        ...
                        "approximate_first_receive_timestamp": msg.get("Attributes", {}).get(
    ...
    async def get_queue_attributes(self, queue_name: str) -> Dict[str, Any]:
        ...
        try:
            ...
            response = self._sqs.get_queue_attributes(QueueUrl=queue_url, AttributeNames=["All"])

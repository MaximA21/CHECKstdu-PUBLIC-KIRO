...
class MockConnectionManager(IConnectionManager):
    ...
    async def send_to_multiple_connections(self, connection_ids: List[str], 
                                          message: Dict[str, Any]) -> Dict[str, bool]:
    ...
    async def broadcast_message(self, message: Dict[str, Any], 
                               connection_filter: Optional[Dict[str, Any]] = None) -> int:
    ...
    async def get_active_connections(self) -> List[str]:
        ...
        return [
            connection_id for connection_id, connection in self._connections.items()
    ...
    def _connection_matches_filter(self, connection: Dict[str, Any], 
    ...
    def add_mock_connection(self, connection_id: str, connection_type: str = "websocket",
...
class MockConnectionNotifier(IConnectionNotifier):
    ...
    async def notify_search_initiated(self, connection_id: str, request_id: str, 
                                     share_token: str) -> bool:
    ...
    async def notify_search_progress(self, connection_id: str, request_id: str,
                                    provider_name: str, status: str) -> bool:
    ...
    async def notify_search_results(self, connection_id: str, request_id: str,
                                   results_summary: Dict[str, Any]) -> bool:
    ...
    async def notify_search_error(self, connection_id: str, request_id: str,
    ...
    def get_notifications_sent(self, connection_id: Optional[str] = None,
    ...
    def get_stats(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "unique_connections_notified": len(set(
                n["connection_id"] for n in self._notifications_sent
            ))
        }
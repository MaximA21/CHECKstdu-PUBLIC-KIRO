...
class MockWorkflowOrchestrator(IWorkflowOrchestrator):
    ...
    async def _simulate_workflow_execution(self, execution_id: str) -> None:
        ...
        try:
            ...
            execution["output"] = {
                ...
                "execution_time_seconds": (execution["ended_at"] - execution["started_at"]).total_seconds(),
            }
    ...
    def get_execution_stats(self) -> Dict[str, Any]:
        ...
        return {"total_executions": len(self._executions), "status_breakdown": dict(status_counts)}
...
class MockEventBus(IEventBus):
    ...
    async def subscribe_to_events(self, event_pattern: Dict[str, Any], callback: Callable[[Dict[str, Any]], None]) -> str:
        ...
        self._subscriptions[subscription_id] = {"pattern": deepcopy(event_pattern), "created_at": datetime.utcnow()}

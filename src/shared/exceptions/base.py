...
class RetryableException(BaseApplicationException):
    ...
    def __init__(
        self, message: str, max_retries: int = 3, retry_delay: float = 1.0, backoff_multiplier: float = 2.0, **kwargs
    ):
...
class ValidationException(BaseApplicationException):
    ...
    def __init__(self, message: str, field_errors: Optional[Dict[str, List[str]]] = None, **kwargs):
        ...
        Args:
            ...
            **kwargs: Additional arguments for BaseApplicationException
        """
        super().__init__(message, severity=ErrorSeverity.LOW, category=ErrorCategory.VALIDATION, **kwargs)
...
class BusinessLogicException(BaseApplicationException):
    ...
    def __init__(self, message: str, **kwargs):
        ...
        super().__init__(message, severity=ErrorSeverity.MEDIUM, category=ErrorCategory.BUSINESS_LOGIC, **kwargs)
...
class ExternalServiceException(BaseApplicationException):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        Args:
            ...
            **kwargs: Additional arguments for BaseApplicationException
        """
        super().__init__(message, severity=ErrorSeverity.HIGH, category=ErrorCategory.EXTERNAL_SERVICE, **kwargs)
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        result = super().to_dict()
        result.update(
            {"service_name": self.service_name, "status_code": self.status_code, "response_body": self.response_body}
        )
        return result

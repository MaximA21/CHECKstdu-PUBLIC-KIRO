...
class Address:
    ...
    def is_same_location(self, other: 'Address') -> bool:
        ...
        return (
            self.normalized_postal_code == other.normalized_postal_code and
            self.house_number.strip().lower() == other.house_number.strip().lower() and
            self.city.strip().lower() == other.city.strip().lower()
        )
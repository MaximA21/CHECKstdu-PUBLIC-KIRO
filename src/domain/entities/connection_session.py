    ...
    def get_connection_summary(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "connection_duration_seconds": (
                int(self.connection_duration.total_seconds()) 
                if self.connection_duration else None
            ),
            "idle_duration_seconds": (
                int(self.idle_duration.total_seconds()) 
                if self.idle_duration else None
            ),

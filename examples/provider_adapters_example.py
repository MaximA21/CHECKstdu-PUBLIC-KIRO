...
async def main():
    ...
    # Create test address
    address = Address(street="Musterstraße", house_number="42", city="Berlin", postal_code="10115", country="DE")
            ...
            try:
                ...
                if is_valid:
                    ...
                    if offers:
                        ...
                        print(
                            f"  Best Offer: {best_offer.speed_download_mbps} Mbps for {best_offer.monthly_cost_euros}€/month"
                        )
    ...
    fallback_offers = await aggregator.get_offers_with_fallback(address, primary_providers, fallback_providers)

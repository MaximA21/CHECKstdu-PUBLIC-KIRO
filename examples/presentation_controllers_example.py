...
async def demonstrate_lambda_handler():
    ...
    share_use_case.execute.return_value = {
        ...
        "total_offers": 3,
        "offers": [
            {"provider": "TestProvider", "speed": 100, "price": 29.99}
        ],
    ...
    lambda_event = {
        "pathParameters": {"share_token": "abc123"},
...
async def demonstrate_container_controller():
    ...
    share_use_case.execute.return_value = {
        ...
        "total_offers": 5,
        "offers": [
            {"provider": "ContainerProvider", "speed": 200, "price": 39.99}
        ]
    }
...
class CustomHTTPController(HTTPController):
    ...
    async def handle_request(self, request_data):
        ...
        # Log request
        self._logger.info("Custom controller handling request", {
            "method": method,
            "path": path,

...
def test_lambda_error_handler():
    ...
    for error in test_cases:
        context = {"request_id": f"req_{test_cases.index(error)}", "operation": "test_operation"}
...
def test_error_serialization():
    ...
    error = ProviderUnavailableException("Test provider error", provider_name="test_provider")

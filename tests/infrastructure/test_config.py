...
class TestConfigLoader:
    ...
    @patch.dict(os.environ, {"APP_ENVIRONMENT": "production", "LOG_LEVEL": "DEBUG", "AWS_REGION": "us-west-2"})
    ...
    def test_merge_configs(self):
        ...
        base_config = AppConfig(environment=Environment.DEVELOPMENT, log_level="INFO", aws_region="eu-central-1")

        override_config = AppConfig(log_level="DEBUG", dynamodb_table_name="override-table")

...
class TestFullSearchFlowIntegration:
    ...
    def mock_websocket_integration(self):
        ...
        with patch('boto3.client') as mock_boto3:
            ...
            mock_apigateway.post_to_connection.return_value = {
    ...
    @pytest.mark.asyncio
    async def test_search_flow_with_mocked_aws(self, integration_container, mock_dynamodb_integration, mock_websocket_integration):
    ...
    @pytest.mark.asyncio
    async def test_result_processing_integration(self, integration_container, mock_dynamodb_integration, mock_websocket_integration):
    ...
    async def test_provider_aggregation_integration(self, integration_container):
        ...
        with patch('src.infrastructure.external_services.ping_perfect_adapter.PingPerfectAdapter.get_offers') as mock_ping, \
    ...
    @pytest.mark.asyncio
    async def test_concurrent_requests_integration(self, integration_container, mock_dynamodb_integration, mock_websocket_integration):

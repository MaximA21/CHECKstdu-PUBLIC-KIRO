...
class TestAddress:
    ...
    def test_address_creation(self):
        ...
        address = Address(street="Musterstraße 1", city="Berlin", postal_code="10115", country="Germany")
    ...
    def test_address_validation(self):
        ...
        # Test empty street
        with pytest.raises(ValueError):
            Address(street="", city="Berlin", postal_code="10115", country="Germany")

    def test_address_equality(self):
        """Test address equality."""
        address1 = Address(street="Musterstraße 1", city="Berlin", postal_code="10115", country="Germany")

        address2 = Address(street="Musterstraße 1", city="Berlin", postal_code="10115", country="Germany")

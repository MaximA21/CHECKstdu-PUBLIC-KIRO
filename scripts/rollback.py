...
class RollbackManager:
    ...
    def execute_rollback(self, target_versions: Dict[str, str], 
...
def main():
    ...
    parser.add_argument('--list-versions', action='store_true',
                       help='List available versions for rollback')
    parser.add_argument('--current-versions', action='store_true',
                       help='Show current active versions')
    parser.add_argument('--target-version', 
                       help='Target version for all functions')
    parser.add_argument('--function-versions', 
                       help='JSON string with function-specific versions')

    ...
    def validate_monitoring_setup(self, api_name: str) -> Dict[str, Any]:
        ...
        try:
            ...
            response = self.cloudwatch.describe_alarms(
                AlarmNamePrefix=f"provider-comparison-dev-{api_name.replace('-', '-')}"
            )
            ...
            try:
                dashboard_response = self.cloudwatch.get_dashboard(
                    DashboardName=f"provider-comparison-dev-rest-api-canary"
                )

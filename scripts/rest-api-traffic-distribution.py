        ...
        with ThreadPoolExecutor(max_workers=concurrency) as executor:
            ...
            for future in as_completed(futures):
                try:
                    ...
                    results.append({"success": False, "error": str(e), "response_time": None, "endpoint": "unknown"})
...
def main():
    ...
    distributor = RestApiTrafficDistributor(args.prod_endpoint, args.canary_endpoint, args.traffic_split)

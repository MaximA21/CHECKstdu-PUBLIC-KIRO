...
class CostOptimizer:
    ...
    def analyze_log_usage(self, project_name: str, environment: str) -> Dict[str, Any]:
        ...
        lambda_functions = [
            "connect_handler", "disconnect_handler", "search_handler", 
            "results_handler", "requestor_handler", "share_api",
            "authorizer", "address_normalizer", "ping_perfect_signer",
            "connection_limit_enforcer", "connection_router"
        ]
    ...
    def _calculate_log_optimization_savings(self, log_analysis: Dict) -> Dict[str, Any]:
        ...
        savings_scenarios = {
            'reduce_retention_to_7_days': 0,
            'reduce_retention_to_14_days': 0,
            'remove_unused_log_groups': 0
        }
    ...
    def analyze_dynamodb_usage(self, project_name: str, environment: str) -> Dict[str, Any]:
        ...
        tables = [
            f"{project_name}-{environment}-results",
            f"{project_name}-{environment}-analytics"
        ]
    ...
    def analyze_backup_costs(self, project_name: str, environment: str) -> Dict[str, Any]:
        ...
        try:
            ...
            recovery_points = self.backup.list_recovery_points_by_backup_vault(

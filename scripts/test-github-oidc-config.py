...
"""
        ...
        try:
            ...
            result = subprocess.run(["terraform", "fmt", "-check"], capture_output=True, text=True)
            if result.returncode != 0:
            ...
            result = subprocess.run(["terraform", "plan", "-var-file=terraform.tfvars"], capture_output=True, text=True)
            if result.returncode != 0:

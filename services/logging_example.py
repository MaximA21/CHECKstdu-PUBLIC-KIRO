...
def example_lambda_handler(event, context):
    ...
    try:
        ...
        log_with_context(
            ...
            {"processed_count": processed_count, "execution_time_ms": execution_time, "function_name": "example_function"},
        )

        return {
            "statusCode": 200,
            "body": {"message": "Success", "processed_count": processed_count, "execution_time_ms": execution_time},
        }
        ...
        return {"statusCode": 500, "body": {"message": "Internal server error", "error": str(e)}}
...
def demonstrate_structured_logging():
    ...
    log_with_context(
        ...
        {"user_id": "user123", "action": "data_processing", "duration_ms": 150.5, "items_processed": 42},
    )

    # Safe JSON logging
    sample_data = {"request_id": "req-12345", "timestamp": "2025-07-19T11:00:00Z", "data": {"key": "value", "count": 100}}
...
if __name__ == "__main__":
    ...
    sample_event = {"items": ["item1", "item2", "item3"], "source": "api_gateway"}

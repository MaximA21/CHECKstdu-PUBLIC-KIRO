...
# AWS Budget for monthly cost monitoring (15 EUR threshold) - commented out due to syntax issues
...
# Cost anomaly detection for unexpected spikes (commented out - not supported in all regions)
...
# Cost anomaly subscription for alerts (commented out - detector is commented out)
